...
//lentgh of the magic string is hardcoded
#define LENGTH_OF_MAGIC_STRING (2*8)
#define LENGTH_OF_EXTN_SIZE  (1*8)
#define LENGTH_OF_EXTN (4*8)
//#define SIZE_OF_SECRETE_FILE ()
